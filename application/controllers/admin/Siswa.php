...
class Siswa extends CI_Controller {
	...
	public function tambah()
  {
    $post = $this->input->post();
	    ...
	    $this->form_validation->set_rules('nama_ibu', 'Nama Ibu', 'trim|required');
			...
			$this->form_validation->set_rules('tlp_siswa', 'No. Tlp./HP.', 'trim|required|numeric');
	...
	public function edit()
  {
	...
	public function kode($kode)
	{
		...
		$where = array ('kode_siswa' => $kode, 'id_ta_siswa' => $ta);
	...
	public function edit_kode($kode)
	{
		...
		$where = array ('kode_siswa' => $kode, 'id_ta_siswa' => $ta, 'id_siswa !=' => $id);
		$cek = $this->siswa_m->cek_data($where, 1);
	  if ($cek){
