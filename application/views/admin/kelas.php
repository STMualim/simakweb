      ...
      [
        ...
        {data: "id_kelas", orderable: false, searchable: false, render: function(data, type, row) {
          return `<div class="text-center">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item edit-data" href="javascript:void(0)" data-id="`+row.id_kelas+`" data-kode="`+row.kode_kelas+`" data-nama="`+row.nama_kelas+`" data-pegawai="`+row.id_pegawai_kelas+`"><i class="bx bx-edit"></i> Edit</a>
